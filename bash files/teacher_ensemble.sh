...
for CL_steps in "${values[@]}"; do
    ...
    distill_teacher1=teacher_ensemble/T1_seed$seed-warmup_steps$CL_steps-distillation_stopping_steps$distillation_stopping_steps
    distill_teacher2=teacher_ensemble/T2_seed$seed-warmup_steps$CL_steps-distillation_stopping_steps$distillation_stopping_steps
